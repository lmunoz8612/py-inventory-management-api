...
```
> **Nota:** Para instalar las herramientas de desarrollo (como `black` y `pre-commit`), ejecuta `pip install -r requirements-dev.txt`.
...
| GET  | /api/inventory/transfer/ | Listar transferencias                   |
| POST | /api/inventory/transfer/ | Registrar transferencia entre almacenes |
